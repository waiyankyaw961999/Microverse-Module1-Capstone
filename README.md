...
This project is simply built with HTML, CSS and JavaScript along with Boostrap Framework.
...
In order to run this project on your local machine, you will need to clone this repo first. Then, go to the index.html and open it.
...
To run the project, please go the the index.html file and open it.
